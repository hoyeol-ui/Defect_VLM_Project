"""Launch the V6 deficit/diversity active-learning audit on seed 42.

Run from the project root:
    .\.python311\python.exe .\scripts\02_active_learning\launch_v6_seed42_deficit_diversity.py
"""
...
RUNNER = (
    ...
    / "scripts"
    / "02_active_learning"
    / "run_al_yolo_ablation_v6_deficit_diversity.py"
)
    ...
    env.update(
        {
            ...
            "AL_YOLO_PLOTS": "true",
            "AL_YOLO_DEVICE": "0",
            "AL_V6_DIVERSITY_CANDIDATE_FRAC": "0.40",
            "AL_V6_DIVERSITY_LAMBDA": "0.65",
            "AL_V6_DIVERSITY_MIN_CANDIDATE_MULTIPLIER": "4",
        }
    )
